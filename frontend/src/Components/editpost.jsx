...
export default function Edit() {
  ...
  const handleSaveChanges = () => {
    ...
    console.log("Changes saved with data:", { title, description, photo });
  };

  const handleDelete = () => {
    // You can handle post deletion here
    console.log("Post deleted");
  };

  return (
    <Frame>
      <h2 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Edit Post</h2>
