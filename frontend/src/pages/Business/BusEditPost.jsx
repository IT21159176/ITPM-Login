...
const BusinessAdedite = () => {
  ...
  <span style={{ border: '1px solid black', padding: '15px', borderRadius: '5px',backgroundColor:'#36C186' }}>Edit Your Post</span>
</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" style={{ backgroundColor: '#007bff', color: '#fff', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer',position:'center' }}>Edit & Save</button>
      </form>
    </div>
...
export default BusinessAdedite;
